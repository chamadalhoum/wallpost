...
$this->mybusinessService = Helper::GMB();
    ...
    public function photo_missing(Request $request)
    {
        ...
        try {
            ...
            $fiches_interior_list = $fiches_interior->limit(50)->get(['fiches.*'])->toArray();
            $data_interior = [];
            ...
            $fiches_exterior_list = $fiches_exterior->limit(50)->get(['fiches.*'])->toArray();
            $data_exterior = [];
            ...
            $fiches_teams_list = $fiches_teams->limit(50)->get(['fiches.*'])->toArray();
            $data_teams = [];
            ...
            $fiches_identity_list = $fiches_identity->limit(50)->get(['fiches.*'])->toArray();
            $data_identity = [];
            ...
            $fiches_video_list = $fiches_video->limit(50)->get(['fiches.*'])->toArray();
            $data_video = [];
