...
$this->mybusinessService = Helper::GMB();
     ...
     public function photo_missing(Request $request)
    {
        ...
        try {
            ...
            $data['Logo'] = ['count' => $this->shortNumber($fiches_missing_logo->count()), 'list_fiches' => $fiches_missing_logo->get(['fiches.*'])->toArray()];
            ...
            $data['Cover'] = ['count' => $this->shortNumber($fiches_missing_cover->count()), 'list_fiches' => $fiches_missing_cover->get(['fiches.*'])->toArray()];
            ...
            $data['MissingTeams'] = ['count' =>$this->shortNumber($fiches_missing_teams->count()), 'list_fiches' => $fiches_missing_teams->get(['fiches.*'])->toArray()];
            ...
            $data['Interior'] = ['count' => $this->shortNumber($fiches_interior->count()), 'list_fiches' => $data_interior];
            ...
            $data['Exterior'] = ['count' => $this->shortNumber($fiches_exterior->count()), 'list_fiches' => $data_exterior];
            ...
            $fiches_work_list = $fiches_work->limit(10)->get(['fiches.*'])->toArray();
            $data_work = [];
            ...
            $data['Work'] = ['count' => $this->shortNumber($fiches_work->count()), 'list_fiches' => $data_work];
            ...
            $data['Teams'] = ['count' => $this->shortNumber($fiches_teams->count()), 'list_fiches' => $data_teams];
            ...
            $data['Identity'] = ['count' => $this->shortNumber($fiches_identity->count()), 'list_fiches' => $data_identity];
            ...
            $data['Video'] = ['count' => $this->shortNumber($fiches_video->count()), 'list_fiches' => $data_video];
