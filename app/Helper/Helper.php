...
class Helper
{
   ...
   // var_dump($client);exit;
    ...
    public static function Reviewreply(){


        $mybusinessService = new \Scottybo\LaravelGoogleMyBusiness\Google_Service_MyBusiness_ReviewReply();
          return($mybusinessService);
...
return ($mybusinessService);
    ...
    public static function GMBReview(){
        $credentialsPath = CREDENTIALS_PATH;
        $client = Google::getClient();
        ...
        $mybusinessService = new \Scottybo\LaravelGoogleMyBusiness\Google_Service_MyBusiness_Review($client);
    ...
    public static function GMBLOCATIONPOST(){
        ...
        $mybusinessService->alertType='COVID_19';
        return($mybusinessService);
    }
    ...
    public static function DrivingDirectionsRequestAction(){
        $mybusinessService = new \Scottybo\LaravelGoogleMyBusiness\Google_Service_MyBusiness_DrivingDirectionMetricsRequest();
    ...
    public static function SpecialHourPeriod(){


        $mybusinessService = new \Scottybo\LaravelGoogleMyBusiness\Google_Service_MyBusiness_SpecialHourPeriod();
             return($mybusinessService);
