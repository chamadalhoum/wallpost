    ...
    <div style="display: flex; justify-content: flex-end!important; align-items: center; float: right; width: 60%px; max-width: 300px">
        ...
        <img src="https://api-wallpost.b-forbiz.com/public/app/public/icon/user.jpg" style="font-family: 'Ubuntu', sans-serif; display: block; border-radius: 50%; width: 150px; height: 150px; margin: 0px 10px">
            ...
            <div style="margin: 20px 0px; padding: 1px 30px; color: white; line-height: 20px">
                <span style="font-size: 15px"><span style="font-size: 15px; font-family: 'Ubuntu', sans-serif; color: #f0ba0e; padding-right: 10px">|</span>Relance <span style="font-weight: bold"> code GMB</span></span>
            ...
            <div style="margin: 20px 15px; padding: 10px 30px; color: #000; background: white; line-height: 20px; border-radius: 8px">
                ...
                <div style="padding-bottom: 0px; border-bottom: 1px dashed gray">
                    ...
                    <br>
                    <span style="font-family: 'Ubuntu', sans-serif; font-size: 14px; display: block">Saisir le code</span><br>
                    <span style="font-family: 'Ubuntu', sans-serif; font-size: 18px; display: block">Saisissez le code de validation</span><br>
                    <span style="font-family: 'Ubuntu', sans-serif; font-size: 18px; display: block">Mot de passe: <b style="font-family: 'Ubuntu', sans-serif; color: #017dc1; font-size: 16px;">{{$password}}</b></span><br>
                    <span style="font-family: 'Ubuntu', sans-serif; font-size: 16px; display: block; text-align: justify">Afin de vous connecter à nouveau sur votre espace client, il vous suffit d'entrer
                        <span style="font-weight: bold">votre adresse e-mail</span> dans le champ "Identifiant" et votre  mot de passe dans le champ dédié.</span><br>


                </div><br>
                <a href="https://wallpost.b-forbiz.com/" style="font-family: 'Ubuntu', sans-serif; display: block; max-width: 300px; margin: 0 auto; color: white; font-size: 16px; box-shadow: 0px 0px 5px 1px rgba(66, 66, 66, 0.3); padding: 10px 15px; background: #f0ba0e; text-align: center; text-decoration: none!important; border-radius: 8px; line-height: 20px" target="_blank" rel="noreferrer">
