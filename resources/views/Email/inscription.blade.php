...
@component('mail::layout')
    ...
    <div style="display: flex; justify-content: flex-end!important; align-items: center; float: right; width: 60%px; max-width: 300px">
        ...
        <div style="font-family: 'Ubuntu', sans-serif; float: left; text-align: center">
            <a href="https://wallpost.b-forbiz.com/" style="font-family: 'Ubuntu', sans-serif; display: inline-block; color: white; font-size: 12px; border: 1px solid white; padding: 7px 10px; text-align: center; text-decoration: none!important; border-radius: 8px; line-height: 18px; margin: 10px 0" target="_blank" rel="noreferrer">GÉRER MON COMPTE</a>
